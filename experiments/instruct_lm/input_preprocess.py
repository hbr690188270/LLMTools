"""
One example input preprocessor to apply chat template to SFT data and construct the
necessary inputs to LLMs (`input_ids` and `labels`). Currently, it only supports a
simple chat template, and we are still working on to support more models like LLaMA3.
"""
